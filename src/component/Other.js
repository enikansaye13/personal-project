...
function Others() {
    return (
        <section className="others" >
            <h1 className="container">OTHER SERVICES</h1>
            <img
            ...
            <Container>
                <Row>
                    <Col md={6}>
                        <h4>POST -CONSTRUCTION/RENOVATION CLEANING</h4>
                    ...
                    <Col md={6}>
                        <h4>FLOOR CARE AND MAINTENANCE</h4>
                        ...
                        <h4>SPECIAL REQUEST CLEANING</h4>
                        <h5>WHATEVER YOUR PROFESSIONAL CLEANING NEEDS ARE, WE’RE CONFIDENT WE’LL MAKE YOU SMILE ALWAYS.</h5>
                    </Col>
                </Row>
            </Container>
        </section>
